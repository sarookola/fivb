...
//        }
    ...
    private void initComponents() {
        ...
        jButtonsetingold = new javax.swing.JButton();
        ...
        jButtonsetingold.setText("Load Setting old");
        jButtonsetingold.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonsetingoldActionPerformed(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGap(34, 34, 34)
                .addComponent(jButtonsetingold, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(18, 18, 18))
        );
    ...
    private void jButtonsetingoldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonsetingoldActionPerformed
        // TODO add your handling code here:
        loadsettingOld();
        
    }//GEN-LAST:event_jButtonsetingoldActionPerformed
    ...
    private javax.swing.JButton jButtonsetingold;
...
//        System.out.println("update w="+settings.getDrawinGObjectses()[0].getDrawinGObject()[0].getWidthRelative());
    ...
    private void loadsetting(String st) {
        ...
        settingcode = Integer.parseInt(jSpinnerSeetingCODE.getValue().toString());
        jSpinnerSeetingCODE.setValue(settingcode);
    }
    
    private SettingPackOld loadsettingold (String st) {
        
        SettingPackOld setold = new FileManipulat().loadSettingold(st, server.getobjecsArrayLenght());
...
//                             set   System.out.println("color1="+settings.getDrawSettings()[x].getDrawinGObject()[i].getTextC().getRGB()+" and set");
    ...
    private void loadsettingOld() {
        ...
        if (chooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            {
                SettingPackOld setold = loadsettingold(chooser.getSelectedFile().getPath());
                settings.readold(setold);
                comboResets();
            }
        }
...
//           setdrawImagevisall(x);
            ...
            dimsPanel.setAnimaLoop(settings.getDrawSettings()[x].isAnimloop());
            dimsPanel.setImage(settings.getDrawSettings()[x].getImage());
            dimsPanel.setMargin(settings.getDrawSettings()[x].getMargin());
...
//            reCalDimByLink(selectItem, linkOld, linkNew);
    ...
    private void updateSettingFromDim() {
        ...
        settings.getDrawSettings()[x].setAnimloop(dimsPanel.isanimLoop());
        settings.getDrawSettings()[x].setSequencCount(dimsPanel.getAnimFrame());
        settings.getDrawSettings()[x].setMargin(dimsPanel.getmargin());
