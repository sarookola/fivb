...
public class DrawTextOn {
     ...
     * @param textC
     */
    public void drawText(Rectangle2D rectangle, double xRelative, double yRelative, double widthRelative, double heightRelative, String text1, int margin, Color textC, Color strokC) //outlined
    {
        text1 = text1.trim();
        if (text1.equals("")) {
            text1 = " ";
...
//
                ...
                double xoffset = (rectangle.getWidth() * widthRelative - scaleWidth * tlBounce.getWidth()) * .45 * margin;
...
//                 System.out.println("this is ="+text2+" recwi="+rectangle.getWidth() * widthRelative+"   :"+scaleWidth * tlBounce2.getWidth());
    ...
    public void drawTextWithBack(Rectangle2D rectangle, double xRelative, double yRelative, double widthRelative, double heightRelative, String text1, int margin, Color strokC, Color textC, Color back, int alpha) {
//        g2D.setColor(back);
//        g2D.fillRect((int) (xRelative * rectangle.getWidth()), (int) (yRelative * rectangle.getHeight()), (int) (rectangle.getWidth() * widthRelative), (int) (heightRelative * rectangle.getHeight()));
        ...
        drawText(rectangle, xRelative, yRelative, widthRelative, heightRelative, text1, margin, strokC, textC);
