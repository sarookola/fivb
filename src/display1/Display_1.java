...
public class Display_1 extends javax.swing.JPanel implements AnimatorJpanel {
    ...
    public Display_1() {
        ...
        animPlayer.setSleep(10);
        animPlayer.start();
        fpersecondtimer = new Date().getTime();
        try {
...
//                        System.out.println("text="+drawItemDisplay[i].getText1());
                    drawTextOn.drawText(r, drawItemDisplay[i].getxRelative(), drawItemDisplay[i].getyRelative(), drawItemDisplay[i].getWidthRelative(), drawItemDisplay[i].getHeightRelative(), drawItemDisplay[i].getText1(), drawItemDisplay[i].getMargin(), colormain, colorstrok);
                }
            }
        }
    ...
    public void animate(long miliframe) {
        /*
         ...
         if(temp > (fpersecondtimer+1000)){
         fpersecondtimer=new Date().getTime();
         System.out.println("f/s="+fpscounter);
         fpscounter=0;
         }
         fpscounter++;
         */
        miliTimerHolder = miliframe;
        if (letanimate) {
//            System.out.println("letanim pass");
            letanimate = false;
...
//           System.out.println("false animate at" + miliframe);
        }
...
//                }
    ...
    void upDate(FivbControolPack controolPack) {

        letanimate = false;
        showNotAnim = true;
        updateData(controolPack);
        updateanims(controolPack);
        imagePlay(miliTimerHolder);
        objectAnim(miliTimerHolder);
...
//            System.out.print(" -" + i);
//            if (i == 51) {
//                System.out.print(" infor=" + mili20sec);
//            }
            if (objectmotion[i]) {
...
//                System.out.println("imagePlay" + i + "  is " + imagePlay[i]);
                ...
                if (mili20Frame >= setting.getDrawSettings()[i].getSequencCount()) {
                    int animlong = setting.getDrawSettings()[i].getSequencCount();
                    if (drawItemDisplay[i].isAnimLoop()) {
                        drawItemDisplay[i].setimageSeq(mili20Frame % animlong);
                    } else {
                        drawItemDisplay[i].setimageSeq(animlong - 1);
                        imagePlay[i] = false;
                    }
                } else {
    ...
    private void imagePlay_old(long mili20sec) {
        for (int i = 0; i < objecsArrayLenght; i++) {
            if (imagePlay[i]) {
//                System.out.println("imagePlay" + i + "  is " + imagePlay[i]);
                int mili20Frame = (int) (mili20sec - start_zero[i]);
...
//        System.out.println("motionDimsIndexi= "+motionDimsIndex[i]);
        ...
        Color c2 = c1;
        if (setting.getDrawSettings()[i].getDrawingDimsByIndex(motionDimsIndex[i]).length > current + 1) {
            c2 = setting.getDrawSettings()[i].getDrawingDimsByIndex(motionDimsIndex[i])[current + 1].getTextC();
        }
...
//        if (drawItemDisplay[child].isImagevisiblity()) {
////System.out.print("\ton in fitst parent="+opac);
//            drawItemDisplay[child].setImagepicAlpha(opac);
//        }
    }
...
//        System.out.println("i=" + i + "  current=" + current + " setting.getDrawSettings()[i]=" + setting.getDrawSettings()[i].getText1() + " =");
    ...
    private void updateanims(FivbControolPack controolPack) {
        for (int i = 0; i < objecsArrayLenght; i++) {
            objectmotion[i] = false;
...
//            }
    ...
    private void updateData(FivbControolPack controolPack) {

        drawItemDisplay[60].setText1(controolPack.getCountry1());
        drawItemDisplay[61].setText1(controolPack.getCountry2());

        drawItemDisplay[65].setText1(controolPack.getSet1());
        drawItemDisplay[66].setText1(controolPack.getSet2());
        drawItemDisplay[67].setText1(controolPack.getPoint1());
        drawItemDisplay[68].setText1(controolPack.getPoint2());

        if (!drawItemDisplay[63].getImage().equals(controolPack.getInd1())) {
            drawItemDisplay[63].setImage(controolPack.getInd1());
        }
        if (!drawItemDisplay[64].getImage().equals(controolPack.getInd2())) {
            drawItemDisplay[64].setImage(controolPack.getInd2());
        }

        drawItemDisplay[34].setText1(controolPack.getCrunchAdd_bot());
        drawItemDisplay[35].setText1(controolPack.getCrunchAdd_bot());
        drawItemDisplay[36].setText1(controolPack.getCrunchAdd_top());
        drawItemDisplay[37].setText1(controolPack.getCrunchAdd_top());

        drawItemDisplay[77].setText1(controolPack.getPoint1());
        drawItemDisplay[78].setText1(controolPack.getPoint2());

        drawItemDisplay[69].setText1(controolPack.getSetScoreTop(0));
        drawItemDisplay[71].setText1(controolPack.getSetScoreTop(1));
        drawItemDisplay[73].setText1(controolPack.getSetScoreTop(2));
        drawItemDisplay[75].setText1(controolPack.getSetScoreTop(3));
        drawItemDisplay[70].setText1(controolPack.getSetScoreBot(0));
        drawItemDisplay[72].setText1(controolPack.getSetScoreBot(1));
        drawItemDisplay[74].setText1(controolPack.getSetScoreBot(2));
        drawItemDisplay[76].setText1(controolPack.getSetScoreBot(3));

        for (int i = 0; i < 9; i++) {
            drawItemDisplay[108 - i].setText1(controolPack.getScoreHistory().getscore1(0 + i));
            drawItemDisplay[118 - i].setText1(controolPack.getScoreHistory().getscore2(0 + i));
        }
        drawItemDisplay[120].setText1(controolPack.getPoint1());
        drawItemDisplay[121].setText1(controolPack.getPoint2());

        //Player name
        if (!drawItemDisplay[162].getImage().equals(controolPack.getPlayernamedata().getCountryPic())) {
            drawItemDisplay[162].setImage(controolPack.getPlayernamedata().getCountryPic());
        }
        drawItemDisplay[154].setText(controolPack.getPlayernamedata().getAge());
        drawItemDisplay[155].setText(controolPack.getPlayernamedata().getHeightPlayer());

        drawItemDisplay[163].setText(controolPack.getPlayernamedata().getCountry());
        drawItemDisplay[164].setText(controolPack.getPlayernamedata().getNumber());
        drawItemDisplay[165].setText(controolPack.getPlayernamedata().getNamePlayer());

        //score result set
        if (!drawItemDisplay[190].getImage().equals(controolPack.getPlayernamedata().getCountryPicHost())) {
            drawItemDisplay[190].setImage(controolPack.getPlayernamedata().getCountryPicHost());
        }
        if (!drawItemDisplay[191].getImage().equals(controolPack.getPlayernamedata().getCountryPicGuest())) {
            drawItemDisplay[191].setImage(controolPack.getPlayernamedata().getCountryPicGuest());
//            System.out.println("guest pic:" + controolPack.getPlayernamedata().getCountryPicGuest());
        }
        drawItemDisplay[192].setText(controolPack.getCountry1());
        drawItemDisplay[193].setText(controolPack.getCountry2());
        drawItemDisplay[194].setText(controolPack.getSet1());
        drawItemDisplay[195].setText(controolPack.getSet2());
        for (int i = 0; i < 5; i++) {
            drawItemDisplay[196 + (2 * i)].setText(controolPack.getSetScoreTop((i)));
            drawItemDisplay[197 + (2 * i)].setText(controolPack.getSetScoreBot((i)));
            drawItemDisplay[209 + i].setText(controolPack.getSetDuration((i)));
        }
        drawItemDisplay[206].setText(controolPack.getSetScoreTop((4)));
        drawItemDisplay[207].setText(controolPack.getSetScoreBot((4)));
        drawItemDisplay[214].setText(controolPack.getSetDuration((4)));

        //PbPvertical
        drawItemDisplay[265].setText1(controolPack.getCountry1());
        drawItemDisplay[266].setText1(controolPack.getCountry2());

        drawItemDisplay[263].setText1(controolPack.getSet1());
        drawItemDisplay[264].setText1(controolPack.getSet2());


        if (!drawItemDisplay[267].getImage().equals(controolPack.getInd1())) {
            drawItemDisplay[267].setImage(controolPack.getInd1());
        }
        if (!drawItemDisplay[268].getImage().equals(controolPack.getInd2())) {
            drawItemDisplay[268].setImage(controolPack.getInd2());
        }


        for (int i = 0; i < 9; i++) {
            drawItemDisplay[251 - i].setText1(controolPack.getScoreHistory().getscore1(0 + i));
            drawItemDisplay[261 - i].setText1(controolPack.getScoreHistory().getscore2(0 + i));
        }
                drawItemDisplay[252].setText1(controolPack.getPoint1());
        drawItemDisplay[262].setText1(controolPack.getPoint2());
    }

    private void updatevisibility(FivbControolPack controolPack) {
        for (int i = 0; i < objecsArrayLenght; i++) {
...
//            System.out.println("   >" + drawSettingChild.getDrawingDimsByIndex(activeDimIndex).length);
        ...
        drawItemDisplay[i].setMargin(settings.getDrawSettings()[i].getMargin());
//      System.out.println("im"+settings.getDrawSettings()[i].getImage());
        ...
        if (visible) {
            ...
            if (setting.getDrawSettings()[i].getSequencCount() > 0 & setting.getDrawSettings()[i].isImageSequency()) {
                drawItemDisplay[i].setimageSeq(setting.getDrawSettings()[i].getSequencCount() - 1);
                drawItemDisplay[i].setAnimLoop(setting.getDrawSettings()[i].isAnimloop());
            }
